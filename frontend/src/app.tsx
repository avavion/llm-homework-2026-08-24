...
import { Bell, Camera, ChefHat, Package, UserRound } from 'lucide-react'
import { api, ApiError, apiMode, type NotificationSetting, type Profile } from './api'
import { Alert, AppShell, EmptyState, Skeleton, StatusBadge, WaveDivider, statusLabel, trapDialogTabKey, type Status } from './ui'
...
function ProductList() {
  ...
  return <div className="dashboard"><section className="hero hero--dashboard"><div className="hero-title"><span className="kicker">{todayLabel}</span><h1>{heroLine1}<br />{heroLine2}</h1></div><p className="hero-sub">{t.heroSubtitle}</p><WaveDivider /></section>
