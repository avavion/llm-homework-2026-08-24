...
const PublicPage = ({ title, kicker, subtitle, children }: { title: string; kicker?: string; subtitle?: string; children?: ReactNode }) => <main id="main-content" className="public-page"><Page title={title} kicker={kicker} subtitle={subtitle}>{children}</Page></main>
