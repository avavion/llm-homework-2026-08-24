# Shared: обязательный журнал сессии

Это правило обязательно для всех агентов, работающих в `shared/`, включая
агентов продукта, исследований и документации.
...
2. В созданном `shared/sessions/session-YYYY-MM-DD-HHMMSS.md` запишите все
...
Невалидный отчёт означает, что shared-сессия не завершена. Архивные отчёты
