# Backend: обязательный журнал сессии

Это правило обязательно для всех агентов, работающих в `backend/`, включая
проектного менеджера, разработчика, QA и DevOps.
...
2. В созданном `backend/sessions/session-YYYY-MM-DD-HHMMSS.md` запишите все
...
Невалидный отчёт означает, что backend-сессия не завершена. Архивные отчёты
